...
class PluginUsageIT {
    ...
    private static final String IMAGE = "jenkins/jenkins:2.504.3";
    ...
    private final GenericContainer<?> jenkins = new GenericContainer<>(DockerImageName.parse(IMAGE))
            ...
            .withCopyFileToContainer(MountableFile.forClasspathResource("update-center.2.504.3.json"), "/tmp/update-center.json")
            .withEnv("JAVA_OPTS",
